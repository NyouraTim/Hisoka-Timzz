...
const nyoutube = ('© Timzz\nNumber owner :\nhttp://s.id/1oHSw')  //ubah di config biar ngk emror
...
⭔ Url : ${anu.url}
jangan lupa follow ig @nyour_tim`,
                    footer: botname,
                    buttons: buttons,
                    headerType: 4
                }
...
papah.sendMessage(m.chat, { caption: 'Kamu bisa mengubahnya menjadi Video Tanpa Watermark atau Audio, pencet tombol dibawah untuk mengubahnya!', video: { url: data.watermark }, buttons: buttons, footer: `© Timzz-Bot`, mentions: [sender] })
})
}
break
            case 'tiktoknowm':{
 ...
 break
            ...
            let kukiw = `*Kak ${pushname}*`
	           ...
	           rows: [
                ...
                rows: [
                {title: "✦  「 Group 」", rowId: `mgroup`, description: `╰ ► 👥Fitur Buat Grup, Tapi Hati Hati Admin ⁠≧⁠▽⁠≦`},
                ...
                {title: "✦  「 Primbon 」", rowId: `mprimbon`, description: `╰ ► Mau nanya apa kak? ⁠≧⁠▽⁠≦ `},
                {title: "✦  「 Convert 」", rowId: `mconvert`, description: `╰ ► 🛠Mau Buat Apa? ⁠≧⁠▽⁠≦`},
                {title: "✦  「 Main 」", rowId: `mmain`, description: `╰ ► 💾Senjata Admin & Owner ⁠≧⁠▽⁠≦`},
                {title: "✦  「 Database 」", rowId: `mdatabase`, description: `╰ ► 📁gak Ada Apa² Disini ⁠≧⁠▽⁠≦`},
                ...
                {title: "✦  「 Owner 」", rowId: `mowner`, description: `╰ ► 🎟Owner lagi sibuk mencari kesibukan ⁠≧⁠▽⁠≦`}
                ]
                },{
	           title: ' ∫ » SUPPORT ME –––––––·│⭔',
	           rows: [
...
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: '.allmenu', buttonText: { displayText: '🧾All menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '👑Donasi' }, type: 1 }]
            ...
            let me = m.sender
            let ments = [ownernya, me, ini_mark]
                anu = `_*${ucapanWaktu} Kak ${m.pushName} 👋*_
...
-- *T H A N K S T O* --
Mark kang banned (@${ini_mark.split('@')[0]})
DikaArdnt As Developer
NazeDev As Owner Base
TimzzDev As Owner Bot
*Chitanda Eru Bot* (my inspiration)
*ARG BOT* (my inspiration)
Papah-Chan As Recode
KyuraSaja
Nurutomo
...
Eren
User Timzz Bot`
                let buttons = [{ buttonId: '.simplemenu', buttonText: { displayText: '🧾 Menu simpel' }, type: 1 },{ buttonId: '.rules', buttonText: { displayText: '❗Rules' }, type: 1 }]
