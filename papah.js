...
break
	    case 'play': case 'ytplay': {
                ...
                let buttons = [
                    {buttonId: `ytmp3 ${anu.url}`, buttonText: {displayText: '🎵 Audio (${media.filesizeF})'}, type: 1},
                    {buttonId: `ytmp4 ${anu.url}`, buttonText: {displayText: '🎥 Video (${media.filesizeF})'}, type: 1}
                ]
                let buttonMessage = {
...
papah.sendMessage(m.chat, { caption: 'Kamu bisa mengubahnya menjadi Vidio Tanpa Watermark atau Audio, pencet tombol dibawah untuk mengubahnya!', video: { url: data.watermark }, buttons: buttons, footer: `Create by @timzz.png`, mentions: [sender] })
})
}
break
            case 'tiktoknowm':{
